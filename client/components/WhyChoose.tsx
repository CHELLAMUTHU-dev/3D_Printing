...
const WhyChoose = () => {
  return (
    <div className=" bg-white-100 py-10 pb-30 flex flex-col items-center justify-center">
      <h1 className="text-4xl font-bold mt-5 mb-13 px-10 text-gray-800 self-start">Why Choose Us</h1>
      <div className=" grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-5 px-20 justify-center items-center">
        <div className="bg-white p-6 rounded-lg shadow-md min-w-[250px] max-w-[500px]">
