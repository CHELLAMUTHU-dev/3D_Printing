      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 gap-10 px-15 pb-15">
        <div>
          <img
            ...
            className="w-full h-60 hover:scale-105 transition-transform duration-300 cursor-pointer rounded-lg"
          />
        ...
        <div>
          <img src="/tooling.jpg" alt="Tooling" className="w-full h-60 hover:scale-105 transition-transform duration-300 cursor-pointer rounded-lg" />
        ...
        <div>
          <img src="/dental.jpg" alt="Dental" className="w-full h-60 hover:scale-105 transition-transform duration-300 cursor-pointer rounded-lg" />
        ...
        <div>
          <img src="/medical.jpg" alt="Medical" className="w-full h-60 hover:scale-105 transition-transform duration-300 cursor-pointer rounded-lg" />
        ...
        <div>
          <img src="/packaging.jpg" alt="Packaging" className="w-full h-60 hover:scale-105 transition-transform duration-300 cursor-pointer rounded-lg" />
